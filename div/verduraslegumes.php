      ...
      <div class="row">
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><div class = "fruta"><img src="imagens/imagens.verduras_legumes/cebola.png" width="100" height="85"></div></h2>
            <h5 class="center">Cebola</h5>
            <h5 class="center">R$2,50 Kg</h5>
            <label></label>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.verduras_legumes/cenoura.png" width="100" height="85"></h2>
            <h5 class="center">Cenoura</h5>
            <h5 class="center">R$4,00 Kg</h5>
            <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
                <option value="1">1 kg</option>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.verduras_legumes/jerimum.png" width="100" height="85"></h2>
            <h5 class="center">Jerimum</h5>
            <h5 class="center">R$6,50 Uni</h5>
            <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.verduras_legumes/pepino.png" width="100" height="85"></h2>
            <h5 class="center">Pepino</h5>
            <h5 class="center">R$2,50 Kg</h5>
            <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
        ...
        <div class="col s12 m3">
            <div class="icon-block">
              <h2 class="center brown-text"><img src="imagens/imagens.verduras_legumes/pimentão.png" width="100" height="85"></h2>
              <h5 class="center">Pimentão</h5>
              <h5 class="center">R$2,00 Kg</h5>
              <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
                <option value="1">1 kg</option>
