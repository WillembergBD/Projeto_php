      ...
      <div class="row">
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.frutas/banana_original.jpg" width="100" height="85"></h2>
            <h5 class="center">Banana</h5>
            <h5 class="center">R$4,50 Kg</h5>
            <label></label>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.frutas/maça.png" width="100" height="85"></h2>
            <h5 class="center">Maçã</h5>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.frutas/pera.png" width="100" height="85"></h2>
            <h5 class="center">Pera</h5>
            <h5 class="center">R$4,50 Kg</h5>
            <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
        ...
        <div class="col s12 m3">
          <div class="icon-block">
            <h2 class="center brown-text"><img src="imagens/imagens.frutas/uva.png" width="100" height="85"></h2>
            <h5 class="center">Uva</h5>
            <h5 class="center">R$3,50 Kg</h5>
            <label></label>
            <select class="browser-default">
                <option value="0">Quantidade</option>
                <option value="1">1 kg</option>
        ...
        <div class="col s12 m3">
            <div class="icon-block">
              <h2 class="center brown-text"><div class = "fruta"><img src="imagens/imagens.frutas/Abacaxi.png" width="100" height="85"></div></h2>
              <h5 class="center">Abacaxi</h5>
              <h5 class="center">R$3,00 Uni</h5>
              <label></label>
              <select class="browser-default">
                  <option value="0">Quantidade</option>
